package com.janne.controller;

import com.janne.dto.User;
...
public class UserController {
	...
	public User getUserModelAttribute() {
		_logger.info("suoritetaan getUserModelAttribute()");
		return new User();
	}

	@RenderMapping
	public String prepareView() {
		_logger.info("suoritetaan prepareView()");
		return "user";
	}

	@RenderMapping(params = "javax.portlet.action=success")
	public String showGreeting(ModelMap modelMap) {
		_logger.info("suoritetaan showGreeting()");
	...
	public void submitApplicant(
		...
		_logger.info("suoritetaan submitApplicant()");
